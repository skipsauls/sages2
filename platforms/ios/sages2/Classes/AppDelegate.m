...
// only valid if sages2-Info.plist specifies a protocol to handle
...
*/
    ...
    if ([requestString hasPrefix:@"js-frame:"]) {
        ...
        [self performSelector:NSSelectorFromString(function) withObject: argsAsString ];
